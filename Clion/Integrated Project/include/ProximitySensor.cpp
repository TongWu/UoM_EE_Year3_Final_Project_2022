...
void VCNL4040::AdjustNormalLux (uint16_t CurrentValue) {
...
void VCNL4040::NormalLuxValueDetect () {
	uint16_t LuxValue = 0;
	long TotalValue = 0;
	int i=0;
	for(i=0; i<6;) {
...
bool VCNL4040::LuxSafeAlgorithm (uint16_t CurrentLuxValue) {
	/*
	 * 此算法在后期应用决策树算法实现
...
bool VCNL4040::LuxSafeStateDetect (uint16_t InputValue) {
	/*
